...
// Most structs are autogenerated by simple Rust program that parsed the schema.
// The hard enums that use AnyOf (and similar) are skipped for now.
...
// Type alias.
#[allow(dead_code)] // Not used anywhere in the schema.
type CveResults = Vec<CveResult>;
